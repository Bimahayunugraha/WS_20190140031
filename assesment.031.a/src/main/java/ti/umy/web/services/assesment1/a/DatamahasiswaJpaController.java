...
import ti.umy.web.services.assesment1.a.exceptions.NonexistentEntityException;
import ti.umy.web.services.assesment1.a.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy.web.services_assesment.031.a_jar_0.0.1-SNAPSHOTPU");
